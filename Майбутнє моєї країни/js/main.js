...
let masTex = ['«забруднення навколишнього середовища»', 'Ми вже стали звикати до цих слів і продовжуємо свою бездіяльність', '24%', 'Промисловість', 'забруднення повітря', 'забруднення води', 'збільшення кількості встановлення відповідних сміттєвих баків та своєчасний вивіз сміття', 'дбати про чистоту тієї території, де ми проживаємо']
...
let masTex1 = ['Гори, степи, ліси та водні екосистеми.', 'Екосистеми є домівками для багатьох видів рослин та тварин і мають велике значення для збереження біорізноманітності та стійкості екосистем.', 'Гори та степи.', 'Гори створюють непересічну красу та приваблюють туристів з усього світу.', 'Всі відповіді правильні.', 'Непересічна краса та привабливість для туристів', 'Гори, степи, ліси та водні екосистеми', 'Збереження біорізноманітності та стійкості екосистем']
